 ...
 *
 * <p>
 * This class provides static factory methods for JSON schema validation:
 * <ul>
 ...
 *
 * <p>
 * JSON Schema validation follows the JSON Schema specification. These functions
 * are available in MySQL 8.0.17 and later.
 *
 * @author snowykte0426
 * @since 0.1.0-Dev.1
...
public final class JsonSchemaFunctions {
     ...
     *
     * <p>
     * SQL: {@code JSON_SCHEMA_VALID(schema, document)}
     * </p>
     *
     * <p>
     * MySQL 8.0.17+
     ...
     *
     * <p>
     * Returns true if the document is valid according to the schema, false
     * otherwise. The schema must be a valid JSON Schema object.
     *
     * <p>
     * Example:
     *
    ...
    /**
     * Validates a JSON document against a schema and returns a detailed validation
     * report.
     *
     * <p>
     * SQL: {@code JSON_SCHEMA_VALIDATION_REPORT(schema, document)}
     * </p>
     *
     * <p>
     * MySQL 8.0.17+
     ...
     * <li>{@code reason} - error message if invalid (only present when
     * valid=false)</li>
     * <li>{@code schema-location} - JSON pointer to schema location (if
     * applicable)</li>
     * <li>{@code document-location} - JSON pointer to document location (if
     * applicable)</li>
     * <li>{@code schema-failed-keyword} - the schema keyword that failed (if
     * applicable)</li>
     * </ul>
     *
     * <p>
     * Example output for valid document:
     *
     * <pre>
     * {"valid": true}
     * </pre>
     *
     * <p>
     * Example output for invalid document:
     *
     * <pre>
     * {
     *   "valid": false,
    ...
    /**
     * Validates a document against a schema and returns true if valid. Alias for
     * {@link #jsonSchemaValid(Expression, Expression)}.
     *
     * @param schema
     *            the JSON schema
     * @param document
     ...
     *
     * <p>
     * This extracts the "valid" field from the validation report.
     *
     * @param schema
     *            the JSON schema
     * @param document
     ...
     *
     * <p>
     * Returns NULL if the document is valid.
     *
     * @param schema
     *            the JSON schema
     * @param document
