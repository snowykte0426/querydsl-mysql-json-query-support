 ...
 *
 * <p>This class helps users who want to use plain strings, numbers, or booleans
 * with JSON functions without manually escaping them.</p>
 *
 * @since 0.1.0-Beta.4
 */
public final class JsonEscapeUtils {
     ...
     * }</pre>
     *
     * @param plainString the plain string (e.g., "student:read")
