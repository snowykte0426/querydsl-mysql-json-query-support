 ...
 *
 * <p>
 * This class provides static factory methods for JSON utility operations:
 * <ul>
...
public final class JsonUtilityFunctions {
     ...
     *
     * <p>
     * Returns the JSON value formatted with newlines and indentation. This is
     * useful for debugging and logging JSON data.
     *
     * <p>
     * Example:
     *
    ...
    /**
     * Returns the number of bytes used to store the binary representation of a JSON
     * document.
     *
     * <p>
     ...
     *
     * <p>
     * For a JSON column, this returns the space used to store the JSON document.
    ...
    /**
     * Returns the amount of storage space freed in a JSON column by a partial
     * update.
     *
     * <p>
     ...
     *
     * <p>
     * This function shows how much storage space was freed in a JSON column value
     * by a partial update using JSON_SET, JSON_REPLACE, or JSON_REMOVE. For a value
     * that hasn't been partially updated, this returns 0.
     *
     * <p>
     * Example use case:
     *
     ...
     *
     * <p>
     * Note: This function only works on JSON columns, not on string literals.
     *
     * @param jsonColumn
    ...
    /**
     * Formats and returns a pretty-printed JSON document. Alias for
     * {@link #jsonPretty(Expression)}.
     *
     * @param jsonValue
    ...
    /**
     * Calculates the storage efficiency ratio (freed space / total size). Returns a
     * value between 0.0 and 1.0.
     *
     * <p>
     * This can be useful to determine if a OPTIMIZE TABLE operation would be
     * beneficial for the table.
     *
     * @param jsonColumn
     *            the JSON column expression
